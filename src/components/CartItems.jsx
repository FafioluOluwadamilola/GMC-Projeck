    ...
    <section className="max_padd_container pt-28">
        <table className="w-full mx-auto">
            ...
            <tbody>
                {all_products.map((e) => {
                    if (cartItems[e.id] > 0){
                        return <tr key={e.id} className="border-b border-slate-900/20 p-6 medium-14 text-gray-30 text-center">
            ...
            <div className="flex flex-col gap-10">
                ...
                <div>
                    <div className="flexBetween py-4">
                        <h4 className="medium-14">SubTotal:</h4>
                ...
                <div className="flex flex-col gap-10">
                    ...
                    <div className="flexBetween pl-5 h-12 bg-primary rounded-full ring-1 ring-slate-900/10">
                        <input type="text" placeholder="Enter your coupon code" className="bg-transparent border-none outline-none" />
